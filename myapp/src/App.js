...
function App() {
  ...
  function onClickEvent(e) {
    // console.log(
    //   Array.from(e.target.childNodes).find((DIV) => {
    //     DIV.classList;
    //   })
    // );
    var arr = Array.from(e.target.childNodes);
    if (arr.length > 1) console.log(arr[1].classList);
    ...
    scriptTag.src = "https://media.embedeasy.com/static/widget.js";
    let linkTag = document.createElement("link");
    linkTag.rel = "stylesheet";
    linkTag.href = "https://media.embedeasy.com/static/widget.css";
    document.body.appendChild(linkTag);
    document.body.appendChild(scriptTag);
    // iDiv.insertAdjacentHTML("beforeend", element2);
    // iDiv.insertAdjacentHTML("beforeend", element3);
    // if (
    //   Array.from(targetClass).find((div) => div == "DIVAdded") == undefined &&
    //   Array.from(targetClass).find((div) => div == "DIV") == undefined
    // ) {
  ...
  return (
    ...
    >
      <div className="centerDiv">
        <div className="nameDiv">Hello</div>
        {/* <div
      ...
      `,
        ...
        <script
          type="module"
          src="https://media.embedeasy.com/static/widget.js"
        ></script>
        <link
          rel="stylesheet"
          href="https://media.embedeasy.com/static/widget.css"
        />
      </div>
    </div>
  );
